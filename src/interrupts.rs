...
lazy_static! {
    static ref IDT: InterruptDescriptorTable = {
        ...
        idt[InterruptIndex::Vsync.as_usize()].set_handler_fn(vsync_interrupt_handler);
        idt
    };
}
...
extern "x86-interrupt" fn vsync_interrupt_handler(_stack_frame: InterruptStackFrame) {
    use x86_64::instructions::port::Port;
